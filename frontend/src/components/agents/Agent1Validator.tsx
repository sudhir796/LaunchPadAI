...
export const Agent1Validator: React.FC<Props> = ({ data }) => {
  ...
  const feasibilityNotes = data?.feasibility_notes || "Feasibility notes unavailable.";
    ...
    <div className="bg-white border border-[#E2E8F0]">
      ...
      <div className="px-6 md:px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {weaknesses.length > 0 ? (
              ...
              <p className="text-xs text-slate-400 italic">No specific risks listed.</p>
            )}
          </div>
        </div>
        ...
        <div className="border border-[#E2E8F0] p-5 bg-[#F7F8FA]">
          ...
          <p className="text-sm text-[#0B1220] leading-relaxed font-sans">{feasibilityNotes}</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:space-x-4 border border-[#C9A227]/40 bg-[#C9A227]/5 p-5">
          ...
          <p className="text-sm font-semibold text-[#0B1220] font-sans">{recommendation}</p>
        </div>
      </div>
    </div>
  );
